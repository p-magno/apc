...
printf ("Digite o ano: ");
scanf ("%i", &ano);
// int ano_multiplo__4 = ano % 4 == 0;
// int ano_nao_multiplo_100 = ano % 100 != 0;
// int ano_multiplo_de_4_e_nao_multiplo_de_100 = ano_multiplo__4 && ano_nao_multiplo_100;
// int ano_multiplo_400 = ano % 400 == 0;
// int ano_multiplo_4_e_ano_nao_multiplo_100_ou_ano_multiplo_400 = ano_multiplo_de_4_e_nao_multiplo_de_100 && ano_multiplo_400;
...
// }
// identificar o erro do que eu escrevi acima.
